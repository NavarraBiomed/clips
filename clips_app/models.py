...
class Study(models.Model):
	...
	age_interval = models.CharField(verbose_name = "Age interval", choices = _TRAMOS_EDAD, max_length = 2) #nombre en español?
	sex = models.CharField(verbose_name = "Sex", choices = _SEX, max_length = 1)
	asa = models.IntegerField(verbose_name = "ASA", choices = _ASA )
